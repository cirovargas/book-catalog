...
final class Version20250807170944 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("INSERT INTO app_user (id, email, roles, password) VALUES (DEFAULT, 'admin@project.com', '[\"ROLE_USER\",\"ROLE_ADMIN\"]', '$2y$13\$wlto/IFebs/61rUp9GiB8u/hGFApUhsXGzz8QqgsC8scqnHfuzkri')");
    }
